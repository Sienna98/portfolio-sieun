...
const Home = () => {
  return (
    <div className="relative h-[100vh] min-w-[375px] overflow-x-hidden p-[15px] md:p-[30px] lg:p-[5vh]">
      <Box className="block md:flex w-full h-full">
      ...
      <Box className="text-[11.5rem] absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 leading-none select-none flex items-end w-auto gap-2">
        <motion.h1
